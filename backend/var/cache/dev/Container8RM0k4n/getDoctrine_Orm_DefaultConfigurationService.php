...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\PCComponentRepository' => ['privates', 'App\\Repository\\PCComponentRepository', 'getPCComponentRepositoryService', true],
            'App\\Repository\\PCFactoryComponentRepository' => ['privates', 'App\\Repository\\PCFactoryComponentRepository', 'getPCFactoryComponentRepositoryService', true],
            'App\\Repository\\PerfumeriasRepository' => ['privates', 'App\\Repository\\PerfumeriasRepository', 'getPerfumeriasRepositoryService', true],
            'App\\Repository\\PerfumesClubRepository' => ['privates', 'App\\Repository\\PerfumesClubRepository', 'getPerfumesClubRepositoryService', true],
            'App\\Repository\\PerfumesRepository' => ['privates', 'App\\Repository\\PerfumesRepository', 'getPerfumesRepositoryService', true],
            'App\\Repository\\ProductRepository' => ['privates', 'App\\Repository\\ProductRepository', 'getProductRepositoryService', true],
            'App\\Repository\\StoresRepository' => ['privates', 'App\\Repository\\StoresRepository', 'getStoresRepositoryService', true],
            'App\\Repository\\TargetPublicRepository' => ['privates', 'App\\Repository\\TargetPublicRepository', 'getTargetPublicRepositoryService', true],
        ], [
            'App\\Repository\\BookRepository' => '?',
            'App\\Repository\\PCComponentRepository' => '?',
            'App\\Repository\\PCFactoryComponentRepository' => '?',
            'App\\Repository\\PerfumeriasRepository' => '?',
            'App\\Repository\\PerfumesClubRepository' => '?',
            'App\\Repository\\PerfumesRepository' => '?',
            'App\\Repository\\ProductRepository' => '?',
            'App\\Repository\\StoresRepository' => '?',
            'App\\Repository\\TargetPublicRepository' => '?',
        ])));
